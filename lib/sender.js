...
class Sender extends EventEmitter {
                    ...
                    this.getConnectionWithCache(delivery, (err, connection) => {
                        ...
                        plugins.handler.runHooks('sender:headers', [delivery, connection], err => {
                            ...
                            send((err, info) => {
                                ...
                                console.log('------------------------------delivery.envelope:', delivery.envelope);
                                console.log('------------------------------delivery.from:', delivery.from);
    ...
    handleResponseError(delivery, connection, err, callback) {
        let bounce;
        console.log('-----------------ResponseError:', {code: err.responseCode, response: err.response, message: err.message});
        ...
        console.log('--------------------------------bounce response before:', bounce);
        ...
        console.log('--------------------------------bounce response:', bounce);
